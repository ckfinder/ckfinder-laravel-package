...
This repository contains the CKFinder 3 Package for Laravel 9+. If you are lloking for package for older version of Laravel, please use [version 3](https://github.com/ckfinder/ckfinder-laravel-package/tree/v3.x.x) of this bundle.
